...
public:
	Log() {;}
	static void Line(char* line);// {logprintf("DotnetHook: %s",line);}
	static void Debug(char* line);// {logprintf("DotnetHook Debug: %s",line);}
	static void Warning(char* line);// {logprintf("DotnetHook Warning: %s",line);}
