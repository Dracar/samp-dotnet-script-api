...
namespace Samp.Client
{
    public class Server
    {
        ...
        public String AuthKey = "ChangeMe";
        public bool IsConnected = false;
        public bool IsAuthenticated = false;
        public DateTime LastPacketReceived;

        public const int MAX_BUFF = 1023;
        public byte[] sendbuf = new byte[MAX_BUFF];
        public bool sbuflock = false;
        public int sbufpos = 0;
        ...
        {
            Address = Util.DB_XML.ReadString("DotnetClient", "config", "Address", "127.0.0.1");
            Port = (ushort)Util.DB_XML.ReadInt("DotnetClient", "config", "Port", 7780);
            AuthKey = Util.DB_XML.ReadString("DotnetClient", "config", "AuthKey", "ChangeMe");

            Log.Debug(Address + " / " + Port + " / " + AuthKey);
        }
